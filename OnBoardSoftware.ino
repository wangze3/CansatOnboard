...
void getFlightState() {
  ...
  else if (flightState == 2 && ((lastAlt - dataAlt) > DESCENT) && dataAlt > 400 && dataAlt < 650) {
    flightState = 3; //Stabilizing
  }
  else if (flightState == 2 && (dataAlt < LANDED)){
    flightState = 1; //Go back due to sensor error
  }
  else if (flightState == 3 && (dataAlt <= 310)) {
